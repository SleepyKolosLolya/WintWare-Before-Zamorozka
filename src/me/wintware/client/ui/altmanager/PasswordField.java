   ...
   public void drawTextBox() {
      if (this.func_73778_q()) {
         if (this.getEnableBackgroundDrawing()) {
            RenderUtil.drawSmoothRect((float)(this.xPos - 1), (float)(this.yPos - 1), (float)(this.xPos + this.width + 1), (float)(this.yPos + this.height + 1), (new Color(0, 105, 153)).getRGB());
            RenderUtil.drawSmoothRect((float)this.xPos, (float)this.yPos, (float)(this.xPos + this.width), (float)(this.yPos + this.height), -16777216);
         }
