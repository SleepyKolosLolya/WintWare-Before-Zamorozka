...
import me.wintware.client.module.player.AntiDesync;
...
import me.wintware.client.module.player.Scaffold;
...
public class ModuleManager {
   ...
   public ModuleManager() {
      ...
      this.modules.sort(Comparator.comparing((m) -> {
         return Minecraft.getMinecraft().fontRenderer.getStringWidth(((Module)m).getName());
      }).reversed());
   }
