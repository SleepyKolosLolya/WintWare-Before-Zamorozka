...
public abstract class Entity implements ICommandSender {
   ...
   public void setPosition(double x, double y, double z) {
      ...
      if (this instanceof EntityPlayer) {
         f1 = (this.width + HitBox.expand(this)) / 2.0F;
         f2 = this.height + HitBox.expand(this);
         this.setEntityBoundingBox(new AxisAlignedBB(x - (double)f1, y, z - (double)f1, x + (double)f1, y + (double)f2, z + (double)f1));
      } else {
         f1 = this.width / 2.0F;
         f2 = this.height;
         this.setEntityBoundingBox(new AxisAlignedBB(x - (double)f1, y, z - (double)f1, x + (double)f1, y + (double)f2, z + (double)f1));
   ...
   public void moveEntity(MoverType x, double p_70091_2_, double p_70091_4_, double p_70091_6_) {
      if (this.noClip) {
         ...
         if ((x == MoverType.SELF || x == MoverType.PLAYER) && this.onGround && this.isSneaking() && this instanceof EntityPlayer) {
            for(double var20 = 0.05D; p_70091_2_ != 0.0D && this.world.getCollisionBoxes(this, this.getEntityBoundingBox().offset(p_70091_2_, (double)(-this.stepHeight), 0.0D)).isEmpty(); d2 = p_70091_2_) {
         ...
         if (this.stepHeight > 0.0F && flag && (d2 != p_70091_2_ || d4 != p_70091_6_)) {
            ...
            p_70091_4_ = (double)eventStep.getStepHeight();
   ...
   public void applyEntityCollision(Entity entityIn) {
      if (!Main.instance.moduleManager.getModuleByClass(AntiCollision.class).getState()) {
   ...
   public float getCollisionBorderSize() {
      if (Main.instance.moduleManager.getModuleByClass(HitBox.class).getState()) {
         Main.instance.setmgr.getSettingByName("Expand");
      }
