...
public abstract class EntityPlayer extends EntityLivingBase {
         ...
         if (f > 0.0F || f1 > 0.0F) {
            ...
            if (flag5) {
               if (i > 0) {
                  ...
                  if (Main.instance.moduleManager.getModuleByClass(KeepSprint.class).getState()) {
                     this.motionX *= 0.6D;
                     this.motionZ *= 0.6D;
   ...
   public boolean isPushedByWater() {
      return !this.capabilities.isFlying && !Main.instance.moduleManager.getModuleByClass(NoWaterPush.class).getState();
   }
