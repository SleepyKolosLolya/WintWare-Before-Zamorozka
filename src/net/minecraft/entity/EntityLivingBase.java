...
public abstract class EntityLivingBase extends Entity {
   ...
   private int getArmSwingAnimationEnd() {
      if (this.isPotionActive(MobEffects.HASTE)) {
         ...
         return this.isPotionActive(MobEffects.MINING_FATIGUE) ? 6 + (1 + this.getActivePotionEffect(MobEffects.MINING_FATIGUE).getAmplifier()) * 2 : 11;
      }
   }
   ...
   public Vec3d getLook(float partialTicks) {
      if (!Main.instance.moduleManager.getModuleByClass(KillAura.class).getState() && this instanceof EntityPlayerSP) {
