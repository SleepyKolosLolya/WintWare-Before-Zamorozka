...
import me.wintware.client.event.impl.EventVelocity;
...
public class NetHandlerPlayClient implements INetHandlerPlayClient {
   ...
   public void handleEntityVelocity(SPacketEntityVelocity packetIn) {
      ...
      if (entity != null) {
         EventVelocity velocity = new EventVelocity(entity, (double)packetIn.getMotionX() / 8000.0D, (double)packetIn.getMotionY() / 8000.0D, (double)packetIn.getMotionZ() / 8000.0D);
   ...
   public void sendPacket(Packet<?> packetIn) {
      EventSendPacket ep = new EventSendPacket(packetIn, true);
