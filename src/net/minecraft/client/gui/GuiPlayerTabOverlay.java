...
public class GuiPlayerTabOverlay extends Gui {
   ...
   public void renderPlayerlist(int width, Scoreboard scoreboardIn, @Nullable ScoreObjective scoreObjectiveIn) {
      ...
      while(var8.hasNext()) {
         ...
         if (scoreObjectiveIn != null && scoreObjectiveIn.getRenderType() != IScoreCriteria.EnumRenderType.HEARTS) {
            j4 = this.mc.fontRendererObj.getStringWidth(" " + scoreboardIn.getOrCreateScore(networkplayerinfo.getGameProfile().getName(), scoreObjectiveIn).getScorePoints());
            j = Math.max(j, j4);
         }
      }
      ...
      if (this.header != null) {
         ...
         String s;
         for(Iterator var18 = list1.iterator(); var18.hasNext(); l1 = Math.max(l1, this.mc.fontRendererObj.getStringWidth(s))) {
            s = (String)var18.next();
         }
      }
      ...
      if (this.footer != null) {
         ...
         for(var35 = list2.iterator(); var35.hasNext(); l1 = Math.max(l1, this.mc.fontRendererObj.getStringWidth(s3))) {
      ...
      if (list1 != null) {
         ...
         for(var35 = list1.iterator(); var35.hasNext(); k1 += this.mc.fontRendererObj.FONT_HEIGHT) {
            s3 = (String)var35.next();
            j5 = this.mc.fontRendererObj.getStringWidth(s3);
      ...
      if (list2 != null) {
         ...
         for(var35 = list2.iterator(); var35.hasNext(); k1 += this.mc.fontRendererObj.FONT_HEIGHT) {
            s3 = (String)var35.next();
            j5 = this.mc.fontRendererObj.getStringWidth(s3);
            this.mc.fontRendererObj.drawStringWithShadow(s3, (float)(width / 2 - j5 / 2), (float)k1, -1);
         }
   ...
   protected void drawPing(int p_175245_1_, int p_175245_2_, int p_175245_3_, NetworkPlayerInfo networkPlayerInfoIn) {
      ...
      Color c = Color.WHITE;
      double health = (double)networkPlayerInfoIn.getResponseTime();
      Color healthColor = Color.lightGray;
      if (health < 90.0D) {
         healthColor = Color.green;
      } else if (health > 50.0D) {
         healthColor = Color.yellow;
      } else if (health > 350.0D) {
         healthColor = Color.RED;
      } else if (health > 900.0D) {
         healthColor = new Color(139, 0, 0);
      }

      this.zLevel += 100.0F;
      Minecraft.getMinecraft().fontRenderer.drawStringWithShadow(networkPlayerInfoIn.getResponseTime() + "", (float)(p_175245_2_ + p_175245_1_ - Minecraft.getMinecraft().fontRenderer.getStringWidth(networkPlayerInfoIn.getResponseTime() + "")), (float)p_175245_3_, healthColor.getRGB());
      this.zLevel -= 100.0F;
   }
