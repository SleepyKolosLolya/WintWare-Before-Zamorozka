...
public class AdvancementToast implements IToast {
   ...
   public IToast.Visibility func_193653_a(GuiToast p_193653_1_, long p_193653_2_) {
      ...
      if (displayinfo != null) {
         ...
         if (list.size() == 1) {
            p_193653_1_.func_192989_b().fontRendererObj.drawString(I18n.format("advancements.toast." + displayinfo.func_192291_d().func_192307_a()), 30.0F, 7.0F, i | -16777216);
            ...
            if (p_193653_2_ < 1500L) {
               ...
               p_193653_1_.func_192989_b().fontRendererObj.drawString(I18n.format("advancements.toast." + displayinfo.func_192291_d().func_192307_a()), 30.0F, 11.0F, i | i1);
            } else {
               ...
               for(Iterator var11 = list.iterator(); var11.hasNext(); l += p_193653_1_.func_192989_b().fontRendererObj.FONT_HEIGHT) {
                  String s = (String)var11.next();
                  p_193653_1_.func_192989_b().fontRendererObj.drawString(s, 30.0F, (float)l, 16777215 | i1);
               }
            }
         }
