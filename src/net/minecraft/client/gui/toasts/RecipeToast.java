...
public class RecipeToast implements IToast {
   ...
   public IToast.Visibility func_193653_a(GuiToast p_193653_1_, long p_193653_2_) {
      ...
      if (this.field_193666_c.isEmpty()) {
         ...
         p_193653_1_.func_192989_b().fontRendererObj.drawString(I18n.format("recipe.toast.title"), 30.0F, 7.0F, -11534256);
         p_193653_1_.func_192989_b().fontRendererObj.drawString(I18n.format("recipe.toast.description"), 30.0F, 18.0F, -16777216);
