...
public class GuiCustomizeWorldScreen extends GuiScreen implements GuiSlider.FormatHelper, GuiPageButtonList.GuiResponder {
   ...
   private void createPagedList() {
      ...
      this.list = new GuiPageButtonList(this.mc, width, height, 32, height - 32, 25, this, new GuiPageButtonList.GuiListEntry[][]{aguipagebuttonlist$guilistentry, aguipagebuttonlist$guilistentry1, aguipagebuttonlist$guilistentry2, aguipagebuttonlist$guilistentry3});
   ...
   public void drawScreen(int mouseX, int mouseY, float partialTicks) {
      ...
      drawCenteredString(this.fontRendererObj, this.title, width / 2, 2, 16777215);
      drawCenteredString(this.fontRendererObj, this.subtitle, width / 2, 12, 16777215);
      drawCenteredString(this.fontRendererObj, this.pageTitle, width / 2, 22, 16777215);
      ...
      if (this.confirmMode != 0) {
         ...
         tessellator.draw();
         drawCenteredString(this.fontRendererObj, I18n.format("createWorld.customize.custom.confirmTitle"), width / 2, 105, 16777215);
         drawCenteredString(this.fontRendererObj, I18n.format("createWorld.customize.custom.confirm1"), width / 2, 125, 16777215);
         drawCenteredString(this.fontRendererObj, I18n.format("createWorld.customize.custom.confirm2"), width / 2, 135, 16777215);
