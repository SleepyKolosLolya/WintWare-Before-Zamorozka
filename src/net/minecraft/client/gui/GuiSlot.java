...
public abstract class GuiSlot {
   ...
   public void drawScreen2(int mouseXIn, int mouseYIn, float partialTicks) {
      if (this.visible) {
         ScaledResolution sr = new ScaledResolution(this.mc);
         RenderUtil.drawGradientSideways(0.0D, 0.0D, (double)sr.getScaledWidth(), (double)sr.getScaledHeight(), (new Color(29, 29, 29)).getRGB(), (new Color(29, 29, 29)).getRGB());
