...
public class GuiAdvancement extends Gui {
   ...
   public GuiAdvancement(GuiAdvancementTab p_i47385_1_, Minecraft p_i47385_2_, Advancement p_i47385_3_, DisplayInfo p_i47385_4_) {
      ...
      String s1;
      for(Iterator var10 = this.field_192997_l.iterator(); var10.hasNext(); l = Math.max(l, p_i47385_2_.fontRendererObj.getStringWidth(s1))) {
   ...
   public void func_191821_a(int p_191821_1_, int p_191821_2_, float p_191821_3_, int p_191821_4_, int p_191821_5_) {
      ...
      if (flag1) {
         ...
         for(k1 = 0; k1 < this.field_192997_l.size(); ++k1) {
            this.field_191833_k.fontRendererObj.drawString((String)this.field_192997_l.get(k1), (float)(i1 + 5), (float)(p_191821_2_ + this.field_191826_p + 9 + 17 + k1 * this.field_191833_k.fontRendererObj.FONT_HEIGHT), -5592406, false);
         }
      }
