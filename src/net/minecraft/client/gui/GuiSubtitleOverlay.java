   ...
   public void renderSubtitles(ScaledResolution resolution) {
      ...
      if (this.enabled && !this.subtitles.isEmpty()) {
         ...
         for(Iterator var26 = this.subtitles.iterator(); var26.hasNext(); ++i) {
            ...
            if (!flag) {
               if (d0 > 0.0D) {
                  this.client.fontRendererObj.drawString(">", (float)(l - this.client.fontRendererObj.getStringWidth(">")), (float)(-j1), i2 + -16777216);
               } else if (d0 < 0.0D) {
                  this.client.fontRendererObj.drawString("<", (float)(-l), (float)(-j1), i2 + -16777216);
               }
            }

            this.client.fontRendererObj.drawString(s, (float)(-k1 / 2), (float)(-j1), i2 + -16777216);
