   ...
   public void drawTextBox() {
      if (this.getVisible()) {
         if (this.getEnableBackgroundDrawing()) {
            RenderUtil.drawSmoothRect((float)(this.xPosition - 1), (float)(this.yPosition - 1), (float)(this.xPosition + this.width + 1), (float)(this.yPosition + this.height + 1), (new Color(0, 105, 153)).getRGB());
            RenderUtil.drawSmoothRect((float)this.xPosition, (float)this.yPosition, (float)(this.xPosition + this.width), (float)(this.yPosition + this.height), -16777216);
         }
