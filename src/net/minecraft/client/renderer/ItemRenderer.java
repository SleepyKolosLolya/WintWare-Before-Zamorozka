...
public class ItemRenderer {
   ...
   private void transformFirstPerson(EnumHandSide p_187453_1_, float p_187453_2_) {
      float angle = (float)((int)((double)System.currentTimeMillis() / 1.5D % 360.0D));
      angle = (angle > 180.0F ? 360.0F - angle : angle) * 2.0F;
      angle /= 180.0F;
      float angle2 = (float)((int)((double)System.currentTimeMillis() / 3.5D % 120.0D));
      angle2 = (angle2 > 30.0F ? 120.0F - angle2 : angle2) * 2.0F;
      angle2 /= 1.0F;
      float angle3 = (float)((int)((double)System.currentTimeMillis() / 3.5D % 110.0D));
      angle3 = (angle3 > 30.0F ? 110.0F - angle3 : angle3) * 2.0F;
      angle3 /= 1.0F;
      int random1 = false;
      int random2 = false;
      int random3 = false;
      ...
      float random8 = 0.0F;
      int random10 = false;
      int random1 = (int)(System.currentTimeMillis() / 3L % 360L);
   ...
   private void transformSideFirstPerson(EnumHandSide p_187459_1_, float p_187459_2_) {
      ...
      EventManager.call(event);
      if (Main.instance.moduleManager.getModuleByClass(ViewModel.class).getState()) {
         ...
         if (p_187457_6_.func_190926_b()) {
            ...
            if (p_187457_1_.isHandActive() && p_187457_1_.getItemInUseCount() > 0 && p_187457_1_.getActiveHand() == p_187457_4_) {
               ...
               case BOW:
                  ...
                  f5 = (float)p_187457_6_.getMaxItemUseDuration() - ((float)this.mc.player.getItemInUseCount() - p_187457_2_ + 1.0F);
                  f6 = f5 / 20.0F;
   ...
   private void renderFireInFirstPerson() {
      if (Main.instance.moduleManager.getModuleByClass(NoElementOverlay.class).getState()) {
