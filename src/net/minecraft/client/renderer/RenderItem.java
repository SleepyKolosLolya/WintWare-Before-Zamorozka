   ...
   private void renderEffect(IBakedModel p_191966_1_) {
      ...
      if (!Config.isCustomItems() || CustomItems.isUseGlint()) {
         ...
         if (!Config.isShaders() || !Shaders.isShadowPass) {
            ...
            mode = Main.instance.setmgr.getSettingByName("Enchant color").getValString();
            if (Main.instance.moduleManager.getModuleByClass(EnchantEffect.class).getState()) {
               if (mode.equalsIgnoreCase("Rgb")) {
                  this.func_191965_a(p_191966_1_, Color.getHSBColor(EnchantEffect.hue / 255.0F, 1.0F, 1.0F).getRGB());
               }

               if (mode.equalsIgnoreCase("Custom")) {
                  this.func_191965_a(p_191966_1_, Color.WHITE.getRGB());
               }
            }
