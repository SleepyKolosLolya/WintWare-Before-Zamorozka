...
public class EntityRenderer implements IResourceManagerReloadListener {
   ...
   public void getMouseOver(float partialTicks) {
      ...
      if (entity != null && this.mc.world != null) {
         ...
         while(true) {
            while(var17.hasNext()) {
               Entity entity1 = (Entity)var17.next();
      ...
      if (this.debugView) {
         ...
         if (flag) {
            ...
            if (this.zoomCount < 4.0F) {
               this.zoomCount += 0.025F;
            }
         } else {
            if ((double)this.zoomCount > 1.0D) {
               this.zoomCount -= 0.025F;
            }
   ...
   private void hurtCameraEffect(float partialTicks) {
      if (!Main.instance.moduleManager.getModuleByClass(HurtCam.class).getState()) {
         if (this.mc.getRenderViewEntity() instanceof EntityLivingBase) {
            ...
            float lol = AnimationUtil.moveUD((float)random1, f * 10.0F, 0.1F);
            f = MathHelper.sin(f * f * f * f * lol);
      ...
      if (entity instanceof EntityLivingBase && ((EntityLivingBase)entity).isPlayerSleeping()) {
         ...
         if (this.mc.gameSettings.debugCamEnable) {
            ...
            for(int i = 0; i < 8; ++i) {
               ...
               f4 *= 0.1F;
               f5 *= 0.1F;
               if (!Main.instance.moduleManager.getModuleByClass(CameraClip.class).getState()) {
   ...
   private void renderWorldPass(int pass, float partialTicks, long finishTimeNano) {
      ...
      if (flag) {
         ...
         renderglobal.setupTerrain(entity, (double)partialTicks, icamera, this.frameCount++, this.mc.player.isSpectator() && !Main.instance.moduleManager.getModuleByClass(FreeCam.class).getState());
      }
   ...
   private void updateFogColor(float partialTicks) {
      ...
      if (entity instanceof EntityLivingBase && ((EntityLivingBase)entity).isPotionActive(MobEffects.BLINDNESS)) {
         int i = ((PotionEffect)Objects.requireNonNull(((EntityLivingBase)entity).getActivePotionEffect(MobEffects.BLINDNESS))).getDuration();
         if (i < 20) {
   ...
   private void frameInit() {
      ...
      if (world != null) {
         if (Config.getNewRelease() != null) {
            ...
            new TextComponentString(I18n.format("of.message.newVersion", s1));
   ...
   public void renderTotem(ItemStack totem) {
      if (!Main.instance.moduleManager.getModuleByClass(AntiTotemAnimation.class).getState()) {
