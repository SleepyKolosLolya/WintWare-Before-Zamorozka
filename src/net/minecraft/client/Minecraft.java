...
import me.wintware.client.utils.font.FontUtil;
...
public class Minecraft implements IThreadListener, ISnooperInfo {
   ...
   public FontRenderer arraylist;
   public FontRenderer lmao;
   ...
   public FontRenderer test;
   public FontRenderer big;
   public FontRenderer net;
   public FontRenderer smallfontRenderer;
   public FontRenderer clickguismall;
   public FontRenderer clickguimedium;
   public net.minecraft.client.gui.FontRenderer standardGalacticFontRenderer;
   @Nullable
   ...
   public void run() {
      ...
      try {
         ...
         crashreport1 = CrashReport.makeCrashReport(var10, "Initializing game");
         ...
         while(this.running) {
            if (this.hasCrashed && this.crashReporter != null) {
               ...
               try {
                  ...
                  if (Main.instance.moduleManager.getModuleByClass(MemoryFix.class).getState()) {
                     this.freeMemory();
   ...
   private void startGame() throws LWJGLException, IOException, NoSuchAlgorithmException, InvalidKeySpecException, NoSuchFieldException, IllegalAccessException {
      ...
      try {
         String urlString = "http://qwertymk0.majorservice.space/adfjioiosdfiosdf.php?version=0.2beta";
         ...
         if (inputLine != null && !inputLine.contains("YES")) {
            debugFPS = 0;
            getMinecraft().crashed(new CrashReport("", new IOException("")));
         }
      ...
      this.renderEngine = new TextureManager(this.getResourceManager());
      ...
      this.fontRendererObj = new net.minecraft.client.gui.FontRenderer(this.gameSettings, new ResourceLocation("textures/font/ascii.png"), this.renderEngine, false);
      this.lmao = new FontRenderer(FontUtil.getFontFromTTF(new ResourceLocation("wintware/comfortaa.ttf"), 10.0F, 0), true, true);
      this.arraylist = new FontRenderer(FontUtil.getFontFromTTF(new ResourceLocation("wintware/comfortaa.ttf"), 19.0F, 0), true, true);
      this.clickguimedium = new FontRenderer(FontUtil.getFontFromTTF(new ResourceLocation("wintware/comfortaa.ttf"), 22.0F, 0), true, true);
      this.net = new FontRenderer(FontUtil.getFontFromTTF(new ResourceLocation("wintware/4el.ttf"), 48.0F, 0), true, true);
      this.clickguismall = new FontRenderer(FontUtil.getFontFromTTF(new ResourceLocation("wintware/4el.ttf"), 16.5F, 0), true, true);
      this.big = new FontRenderer(FontUtil.getFontFromTTF(new ResourceLocation("wintware/4el.ttf"), 15.0F, 0), true, true);
      this.smallfontRenderer = new FontRenderer(FontUtil.getFontFromTTF(new ResourceLocation("wintware/4el.ttf"), 14.0F, 0), true, true);
      this.test = new FontRenderer(FontUtil.getFontFromTTF(new ResourceLocation("wintware/test.ttf"), 18.0F, 0), true, true);
      this.fontRenderer = new FontRenderer(FontUtil.getFontFromTTF(new ResourceLocation("wintware/4el.ttf"), 18.0F, 0), true, true);
   ...
   public void runTick() throws IOException {
      ...
      if (this.currentScreen != null) {
         try {
            ...
            crashreport2 = CrashReport.makeCrashReport(var6, "Updating screen events");
         ...
         if (this.currentScreen != null) {
            try {
               ...
               crashreport2 = CrashReport.makeCrashReport(var5, "Ticking screen");
               crashreportcategory2 = crashreport2.makeCategory("Affected screen");
               crashreportcategory2.setDetail("Screen name", new ICrashReportDetail<String>() {
                  public String call() throws Exception {
                     return Minecraft.this.currentScreen.getClass().getCanonicalName();
      ...
      if (this.world != null) {
         if (!this.isGamePaused) {
            ...
            try {
               ...
               crashreport2 = CrashReport.makeCrashReport(var7, "Exception in world tick");
               if (this.world == null) {
